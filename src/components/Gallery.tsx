      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-neutral-900/50 border border-orange-500/20 rounded-full px-4 py-2 backdrop-blur-sm mb-4">
            ...
            <span className="text-sm text-gray-300">Projetos Realizados</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {builds.map((build) => (
            <Card 
              key={build.id} 
              className="bg-neutral-900/50 border-neutral-700 backdrop-blur-sm hover:bg-neutral-900/70 transition-all duration-300 transform hover:scale-105 overflow-hidden group hover:border-orange-500/30 relative"
            >
              <div className="absolute top-4 right-4 w-2 h-2 bg-orange-400 rounded-full animate-pulse z-10"></div>
